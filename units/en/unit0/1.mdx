...
<!-- TODO: could mention pdf version here -->
...
You should be comfortable with basic Python (variables, functions, loops). Elementary linear algebra and calculus help but aren’t required. General familiarity with ML is a bonus—we explain concepts as they arise. Most importantly, bring curiosity about how machines learn to act in the physical world.

If you don't have programming experience, don't worry! The course is designed to be accessible, and we provide explanations for technical concepts as they arise.

<Tip>

**New to robotics?** This course is designed to be beginner-friendly! We start from the basics and build up to advanced concepts. If you have basic programming knowledge and curiosity about how robots work, you're ready to start.
...
* **A computer** with an internet connection (no special hardware required - you can start with simulated environments)
* **Python environment** - We'll use Google Colab if you don't have local setup
* **Optional: GPU access** - Helpful for training but not required for understanding concepts ([Hugging Face Pro](https://huggingface.co/pro) or Google Colab work great)
* **Hugging Face account** - To access datasets and models. If you don't have one yet, you can create one [here](https://huggingface.co/join) (it's free)
...
This course is based on the comprehensive Robotics Tutorial developed by the robotics team at Hugging Face and collaborators.

### Course Contributors

The original tutorial was created by Francesco Capuano, Adil Zouitine, Pepijn Kooijmans, Thomas Wolf, Michel Aractingi, and the broader LeRobot team at Hugging Face, in collaboration with École Normale Supérieure Paris-Saclay.
...
- [Hugging Face Datasets](https://huggingface.co/docs/datasets) - For robotics data handling infrastructure  
...
* If you _found a bug or error_, please [open an issue](https://github.com/huggingface/lerobot/issues/new) and **describe the problem**.
...
For questions about Robotics concepts, LeRobot usage, or course content:

* Check the [LeRobot documentation](https://huggingface.co/docs/lerobot)
* Explore the [LeRobot GitHub repository](https://github.com/huggingface/lerobot)
* Engage with the robotics community on Hugging Face

Now that you have all the information, let's start your Robotics journey! 🤖
