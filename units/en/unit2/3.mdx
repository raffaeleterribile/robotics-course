...
In this section, we’ll build intuition for kinematics. You can think of kinematics as the math that links joint angles to end‑effector positions i.e. where is the hand given the joints? We will do this by walking through a concrete example.
