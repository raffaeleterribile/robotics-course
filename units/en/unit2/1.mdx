...
<!-- TODO: Diagram: three boxes (Manipulation, Locomotion, Mobile Manipulation) with 1–2 concrete examples each. -->
...
<!-- TODO: Side-by-side sketch: "Classical pipeline" boxes vs "Learning-based" end-to-end block. -->
